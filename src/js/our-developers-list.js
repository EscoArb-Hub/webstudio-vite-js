...
const dataDevelopersList = [
...

    {
        ...
        images: {
            ...
            mobile: ['./images/olha-m-1x.jpg', './images/olha-m-2x.jpg', './images/olha-m3x.jpg'],
            default: "./images/igor-m-1x.jpg",
...
// console.log(dataDevelopersList[0].images.tablet[1])
            ...
            <source srcset="
                ...
                <source srcset="
                    ...
                    <source srcset="
                        ...
                        <img class="workers-list__img" src="${item.images.default}" alt="Ігор">
                        </picture>
                        <p class="workers-list__text">${item.name}</p>
                        <h3 class="workers-list__title">${item.position}</h3>
